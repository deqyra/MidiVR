...
namespace MIDI
{
    ...
    public class VirtualMIDIException : System.Exception
    {
        ...
        public VirtualMIDIException() : base()
        {
        }

        public VirtualMIDIException(string message) : base(message)
        {
        }

        public VirtualMIDIException(string message, System.Exception inner) : base(message, inner)
        {
        }

        protected VirtualMIDIException(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
        {
        }
